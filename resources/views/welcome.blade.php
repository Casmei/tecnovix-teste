        ...
        <div class="pt-20">
            ...
            <div class="mb-6 p-4 text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-300" role="alert">
                ...
                <div>
                    ...
                    Neste momento, os livros não têm imagens associadas. Isso é intencional, pois você pode usar suas credenciais do AWS S3 para adicionar imagens. Aproveite a oportunidade para personalizar e adicionar as imagens que desejar. 😁
                </div>
            </div>

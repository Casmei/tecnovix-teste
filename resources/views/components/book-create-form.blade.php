<form action="{{route('books.store')}}" method="POST" enctype="multipart/form-data" class="max-w-6xl mx-auto p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none">
    ...
    <div class="flex ">
        <div class="relative w-full">
            ...
            <input type="text" id="ispn" class="ps-10 p-2.5 mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-600 text-white" placeholder="Search isbn number..." required />
        </div>
        @error('isbn')
    ...
    <div class="flex ">
        <div class="relative w-full">
            ...
            <input type="text" id="cep" class="ps-10 p-2.5 mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-600 text-white" placeholder="Search cep number..." required />
        </div>
        @error('cep')
            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
        @enderror
